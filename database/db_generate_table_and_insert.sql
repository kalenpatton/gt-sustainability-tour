...
CREATE TABLE `locations` (
  ...
  `stop_num` INT UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
The Clough Undergraduate Learning Commons was built with sustainability in mind and is a LEED Platinum academic building on Georgia Tech\'s campus. The building contains various sustainability features, which demonstrates Georgia Tech\'s commitment to sustainable design.\n\n
...
33.7785,-84.3996,
"Buildings and Infrastructure,Energy and Emissions,Water,Materials Management",9),
