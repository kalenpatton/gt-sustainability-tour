    ...
    return (
      ...
      <div className="App">
        ...
        <Header
          ...
          map={this.map}
        />
        <Map  autoplay={this.state.autoplay} textDirection={this.state.textDirection} settingHandler={this.settingHandler} saveMap={this.saveMap} setRef={ref => this.map = ref} nextStopHandler={this.setNextStop}/>
        <Footer/>
